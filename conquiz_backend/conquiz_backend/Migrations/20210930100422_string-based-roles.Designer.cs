...
namespace conquiz_backend.Migrations
{
    ...
    [Migration("20210930100422_string-based-roles")]
    partial class stringbasedroles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("conquiz_backend.Models.RoundsHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("conquiz_backend.Models.GameInstance", b =>
                {
                    ...
                    b.HasOne("conquiz_backend.Models.Participants", "Participants")
                        .WithMany("GameInstance")
            ...
            modelBuilder.Entity("conquiz_backend.Models.RoundQuestion", b =>
                {
                    ...
                    b.HasOne("conquiz_backend.Models.RoundsHistory", "Round")
                        .WithMany("RoundQuestion")
