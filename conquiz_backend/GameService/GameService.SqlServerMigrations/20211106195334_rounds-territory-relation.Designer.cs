...
namespace GameService.SqlServerMigrations.Migrations
{
    ...
    [Migration("20211106195334_rounds-territory-relation")]
    partial class roundsterritoryrelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameService.Models.RoundAnswers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GameService.Models.Questions", b =>
                {
                    b.HasOne("GameService.Models.Rounds", "Rounds")
                        .WithOne("Question")
                        .HasForeignKey("GameService.Models.Questions", "RoundsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GameService.Models.RoundAnswers", b =>
                {
                    b.HasOne("GameService.Models.Answers", "Answer")
