...
namespace GameService.Migrations
{
    ...
    [Migration("20211208100206_capitalRoundIsCompletedCheck")]
    partial class capitalRoundIsCompletedCheck
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameService.Models.Questions", b =>
                {
                    ...
                    b.HasIndex("CapitalRoundId")
                        .IsUnique()
                        .HasFilter("[CapitalRoundId] IS NOT NULL");
            ...
            modelBuilder.Entity("GameService.Models.Questions", b =>
                {
                    b.HasOne("GameService.Models.CapitalRound", "CapitalRound")
                        .WithOne("CapitalRoundQuestion")
                        .HasForeignKey("GameService.Models.Questions", "CapitalRoundId");
            ...
            modelBuilder.Entity("GameService.Models.CapitalRound", b =>
                {
                    b.Navigation("CapitalRoundQuestion");
