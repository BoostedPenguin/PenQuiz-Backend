...
namespace QuestionService.Services
{
    ...
    {
        Task EditQuestion(VerifyChangedQuestionRequest request);
        Task<PaginatedQuestionsResponse> GetUnverifiedQuestions(int pageNumber, int pageEntries);
        Task<PaginatedQuestionsResponse> GetVerifiedQuestions(int pageNumber, int pageEntries);
    ...
    public class AdminQuestionCrudService : IAdminQuestionCrudService
    {
        ...
        public async Task<PaginatedQuestionsResponse> GetVerifiedQuestions(int pageNumber, int pageEntries)
        {
            using var db = contextFactory.CreateDbContext();
            var baseQuery = db.Questions
                .Where(x => x.VerificationStatus == VerificationStatus.VERIFIED && x.SubmittedByUsername != null)
        ...
        public async Task EditQuestion(VerifyChangedQuestionRequest request)
        {
            using var db = contextFactory.CreateDbContext();
            ...
            question = TypeCheckQuestion(request, question);

            db.Update(question);
            await db.SaveChangesAsync();
        }

        private static Questions TypeCheckQuestion(VerifyChangedQuestionRequest request, Questions question)
        {
